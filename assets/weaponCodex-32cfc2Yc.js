import{r as e}from"./a11y-BzYmzXK2.js";import{a as t}from"./whompOfferTheme-vcaMxanP.js";import{Fi as n,aa as r,qo as i}from"./index-eW7JYYki.js";import{Q as a,R as o,X as s,Z as c,s as l,t as u,z as d}from"./evolutions-BFFri4r_.js";var f=Object.freeze({bolt:`Bolt`,beam:`Beam`,aoeBurst:`Burst`,groundPatch:`Ground`,aura:`Aura`,orbit:`Orbit`,homing:`Homing`,pet:`Pet`,sentry:`Sentry`,railgun:`Railgun`,melee:`Melee`});function p(e){return`#${e.toString(16).padStart(6,`0`)}`}function m(e){return p(e.params?.fxColor??a[e.element])}function h(e){return n[e]?.name??e}function g(e){if(i[e]?.evolved){let t=Object.values(u).find(t=>t.evolvedId===e);return t?`Evolved from ${i[t.baseId]?.name??t.baseId} with ${h(t.passiveId)}.`:`Evolved form.`}let t=Object.values(u).filter(t=>t.baseId===e);return t.length===0?`No evolution line.`:`Evolves into ${t.map(e=>`${i[e.evolvedId]?.name??e.evolvedId} (${h(e.passiveId)})`).join(`, `)} at max level.`}function _(e){let t=i[e],n=s(t),r=c(t);return{id:e,name:t.name,desc:t.desc,evolved:t.evolved===!0,cadence:n,cadenceLabel:o[n],cadenceNote:d[n],weaponClass:r,classLabel:f[r],element:t.element,line:g(e),color:m(t),jumpHref:`?fxGallery=${encodeURIComponent(e)}`}}function v(){return Object.keys(i).map(_)}function y(){return Object.values(r).map(e=>({id:e.id,name:e.name,desc:e.desc,feel:e.feel,cadenceLabel:e.cadence.toUpperCase(),cadenceNote:`${e.cadenceLabel.toLowerCase()} — ${e.feel}`,donorName:i[e.donorWeaponId]?.name??e.donorWeaponId,evolutionName:e.evolutionName,color:p(e.color)}))}var b=`whomp-codex-style`,x=`
