import{r as e}from"./a11y-BzYmzXK2.js";import{a as t}from"./whompOfferTheme-vcaMxanP.js";import{r as n}from"./weapons-TlNlbSL3.js";import{Ri as r,wa as i}from"./index-DNfvUL5_.js";import{$ as a,B as o,Q as s,et as c,s as l,t as u,z as d}from"./evolutions-BNELyZua.js";var f=Object.freeze({bolt:`Bolt`,beam:`Beam`,aoeBurst:`Burst`,groundPatch:`Ground`,aura:`Aura`,orbit:`Orbit`,homing:`Homing`,pet:`Pet`,sentry:`Sentry`,railgun:`Railgun`,melee:`Melee`});function p(e){return`#${e.toString(16).padStart(6,`0`)}`}function m(e){return p(e.params?.fxColor??c[e.element])}function h(e){return r[e]?.name??e}function g(e){if(n[e]?.evolved){let t=Object.values(u).find(t=>t.evolvedId===e);return t?`Evolved from ${n[t.baseId]?.name??t.baseId} with ${h(t.passiveId)}.`:`Evolved form.`}let t=Object.values(u).filter(t=>t.baseId===e);return t.length===0?`No evolution line.`:`Evolves into ${t.map(e=>`${n[e.evolvedId]?.name??e.evolvedId} (${h(e.passiveId)})`).join(`, `)} at max level.`}function _(e){let t=n[e],r=s(t),i=a(t);return{id:e,name:t.name,desc:t.desc,evolved:t.evolved===!0,cadence:r,cadenceLabel:d[r],cadenceNote:o[r],weaponClass:i,classLabel:f[i],element:t.element,line:g(e),color:m(t),jumpHref:`?fxGallery=${encodeURIComponent(e)}`}}function v(){return Object.keys(n).map(_)}function y(){return Object.values(i).map(e=>({id:e.id,name:e.name,desc:e.desc,feel:e.feel,cadenceLabel:e.cadence.toUpperCase(),cadenceNote:`${e.cadenceLabel.toLowerCase()} — ${e.feel}`,donorName:n[e.donorWeaponId]?.name??e.donorWeaponId,color:p(e.color)}))}var b=`whomp-codex-style`,x=`
