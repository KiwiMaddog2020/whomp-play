import{l as e}from"./coreProgression-CdjaJHgI.js";import{r as t}from"./weapons-TlNlbSL3.js";import{Bo as n,Si as r,os as i}from"./index-B6-b9sMJ.js";import{B as a,V as o,et as s,nt as c,s as l,t as u,tt as d}from"./evolutions-DsTcSW9p.js";var f=Object.freeze({bolt:`Bolt`,beam:`Beam`,aoeBurst:`Burst`,groundPatch:`Ground`,aura:`Aura`,orbit:`Orbit`,homing:`Homing`,pet:`Pet`,sentry:`Sentry`,railgun:`Railgun`,melee:`Melee`});function p(e){return`#${e.toString(16).padStart(6,`0`)}`}function m(e){return p(e.params?.fxColor??c[e.element])}function h(e){return r[e]?.name??e}function g(e){if(t[e]?.evolved){let n=Object.values(u).find(t=>t.evolvedId===e);return n?`Evolved from ${t[n.baseId]?.name??n.baseId} with ${h(n.passiveId)}.`:`Evolved form.`}let n=Object.values(u).filter(t=>t.baseId===e);return n.length===0?`No evolution line.`:`Evolves into ${n.map(e=>`${t[e.evolvedId]?.name??e.evolvedId} (${h(e.passiveId)})`).join(`, `)} at max level.`}function _(e){let n=t[e],r=s(n),i=d(n);return{id:e,name:n.name,desc:n.desc,evolved:n.evolved===!0,cadence:r,cadenceLabel:a[r],cadenceNote:o[r],weaponClass:i,classLabel:f[i],element:n.element,line:g(e),color:m(n),jumpHref:`?fxGallery=${encodeURIComponent(e)}`}}function v(){return Object.keys(t).map(_)}function y(){return Object.values(e).map(e=>({id:e.id,name:e.name,desc:e.desc,feel:e.feel,cadenceLabel:e.cadence.toUpperCase(),cadenceNote:`${e.cadenceLabel.toLowerCase()} — ${e.feel}`,donorName:t[e.donorWeaponId]?.name??e.donorWeaponId,color:p(e.color)}))}var b=`whomp-codex-style`,x=`
